...
import { Alumno, Curso } from 'src/app/models';
...
export class AsignarAlumnosComponent implements OnInit {
  ...
  asignar(): void {
    this.cursoService.asignarAlumnos(this.curso, this.seleccion.selected).subscribe(c => {
      this.tabIndex = 2;
      Swal.fire('Asignados', 'Alumnos asignados con exito', 'success');
      ...
      e => {
        Swal.fire('Error', 'No se puede asignar. Validar si esta asignado a otro curso', 'error');
      });
  }
